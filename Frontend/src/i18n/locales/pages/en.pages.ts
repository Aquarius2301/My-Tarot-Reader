export const enPages = {
  page: {
    ...
    history: {
      ...
      tabTarot: "Tarot History",
      tabAi: "AI Tarot History",
      empty: "No readings found yet",
      aiEmpty: "No AI readings yet",
      reversed: "Reversed",
      upright: "Upright",
      ...
      aiDeleteConfirmTitle: "Delete this AI reading?",
      aiDeleteOk: "Delete",
      aiDeleteCancel: "Cancel",
      aiDeleteSuccess: "AI reading deleted",
      aiDeleteAria: "Delete AI reading ({{reading}})",
      aiViewAria: "View AI reading ({{reading}})",
      aiReadingTitle: "AI Reading",
      aiReadingInterpretation: "Interpretation",
    },
    aiDraw: {
    ...
    library: {
      ...
      upright: "Upright",
      reversed: "Reversed",
      viewCardAria: "View meanings of {{card}}",
    },
  },
  nav: {
    login: "Sign in",
