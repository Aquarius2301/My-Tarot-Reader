export const viPages = {
  page: {
    ...
    history: {
      ...
      tabTarot: "Lịch sử Tarot",
      tabAi: "Lịch sử AI",
      empty: "Chưa có lịch sử trải bài",
      aiEmpty: "Chưa có lịch sử xem bài AI",
      reversed: "Ngược",
      upright: "Xuôi",
      ...
      aiDeleteConfirmTitle: "Xóa lượt xem bài AI này?",
      aiDeleteOk: "Xóa",
      aiDeleteCancel: "Hủy",
      aiDeleteSuccess: "Đã xóa lượt xem bài AI",
      aiDeleteAria: "Xóa lượt xem bài AI ({{reading}})",
      aiViewAria: "Xem lượt xem bài AI ({{reading}})",
      aiReadingTitle: "Xem bài AI",
      aiReadingInterpretation: "Luận giải",
    },
    aiDraw: {
