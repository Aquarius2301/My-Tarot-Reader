...
import TarotCardMeaningModal from "./TarotCardMeaningModal";

const { Text } = Typography;

/** Tab content that shows the static (physical) tarot read-history grid. */
export default function TarotHistoryTab() {
